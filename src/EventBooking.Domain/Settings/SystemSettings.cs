...
public sealed class SystemSettings
{
    ...
    /// <param name="pendingRegistrationExpiryHours">How long a self-registration request stays confirmable: 1 to 168.</param>
    public void Update(
        ...
        int pendingRegistrationExpiryHours)
    {
        ...
        Guard.Against(
            pendingRegistrationExpiryHours is < 1 or > 168,
            "pendingRegistrationExpiryHours must be between 1 and 168.");

        InviteExpiryDays = inviteExpiryDays;
        MaxAutoRetryCount = maxAutoRetryCount;
        InviteOptionCount = inviteOptionCount;
        PendingRegistrationExpiryHours = pendingRegistrationExpiryHours;
        Version++;
    }
}
