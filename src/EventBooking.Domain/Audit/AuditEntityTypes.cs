...
public static class AuditEntityTypes
{
    ...
    /// <summary>Audit entity name for one anonymous self-registration request.</summary>
    ...
    public static readonly IReadOnlyList<string> All =
        [EventProposal, Event, Invite, Booking, StaffAccessProfile, BookingAppointment, Attendee,
            Location, AppointmentType, AttendeeGroup, EventGroup, SelfRegistration, SystemSettings];
}
