...
/// <summary>
/// The pre-Task-14 issuer: immediate-send with composed tokens. Kept only for event
/// cancellation and recovery start until Tasks 15 and 16 migrate them to the new issuer.
/// </summary>
...
public sealed class LegacyInviteIssuer(
