...
namespace EventBooking.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Scoped to the location per the Phase 1 review: EF cannot model an index across
            // the owner LocationId and the owned Window, so the migration owns it directly.
            migrationBuilder.CreateIndex(
