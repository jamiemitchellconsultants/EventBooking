...
public sealed class OpenApiClientContractTests
{
    ...
    [
        ...
        (typeof(ImportErrorDto), "AttendeeCsvError"),
        (typeof(ImportOutcomeDto), "AttendeeImportOutcome"),
        (typeof(InviteOutcomeDto), "InviteAttendeeOutcome"),
        (typeof(AwaitingAvailabilityDto), "AwaitingAvailabilityRow"),
        (typeof(NoResponseDto), "NoResponseRow"),
        (typeof(DashboardCapacityDto), "EventCapacityRow"),
        ...
        (typeof(AttendeeBookingDto), "AttendeeBookingResponse"),
        (typeof(CancelAttendeeBookingDto), "CancelAttendeeBookingResponse"),
        (typeof(AttendeeReadinessDto), "AttendeeReadinessResponse"),
        (typeof(OutstandingAppointmentTypeDto), "OutstandingAppointmentTypeResponse"),
        (typeof(EmailRetryDto), "RetryEmailOutcome"),
        (typeof(RecoveryInviteOutcomeDto), "StartRecoveryResponse"),
    ];
