...
public sealed partial class DesignCatalogueTests(ApiFactory factory)
{
    ...
    /// asserted first and on its own. Sixty-one is what this parser returns against design 05
    ...
    public void EveryStaffOperationHasAToolAndNoTokenRouteDoes()
    {
        ...
        Assert.Equal(52, AgentOperationCatalog.All.Values.Count(x => x.McpTool is not null));
    }
