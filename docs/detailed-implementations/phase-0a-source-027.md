...
## src/EventBooking.Infrastructure/Persistence/Migrations/EventBookingDbContextModelSnapshot.cs — 1/1

<!-- port-file: {"path":"src/EventBooking.Infrastructure/Persistence/Migrations/EventBookingDbContextModelSnapshot.cs","encoding":"utf8","sha256":"fd9c41ca19a3b406f7b92b337180c282d0f952e051f325c7bf1bbd3bbc3e84ba","parts":1,"part":1} -->
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventBooking.Domain.EmployeeGroups.EmployeeGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("employee_group", null, t =>
                        {
                            t.HasCheckConstraint("ck_employee_group_code_nonblank", "code <> ''");

                            t.HasCheckConstraint("ck_employee_group_name_nonblank", "name <> ''");
                        });
                });

            modelBuilder.Entity("EventBooking.Domain.EmployeeGroups.EmployeeGroupRequirement", b =>
                {
                    b.Property<Guid>("EmployeeGroupId")
                        .HasColumnType("uuid")
                        .HasColumnName("employee_group_id");
                    ...
                    b.HasKey("EmployeeGroupId", "AppointmentTypeId");

                    b.HasIndex("AppointmentTypeId");

                    b.ToTable("employee_group_requirement", (string)null);
                });
            ...
            modelBuilder.Entity("EventBooking.Domain.Candidates.Candidate", b =>
                {
                    b.HasOne("EventBooking.Domain.EmployeeGroups.EmployeeGroup", null)
                        .WithMany()
...
## src/EventBooking.Infrastructure/Persistence/Queries/AppointmentWorkspaceQueries.cs — 1/1

<!-- port-file: {"path":"src/EventBooking.Infrastructure/Persistence/Queries/AppointmentWorkspaceQueries.cs","encoding":"utf8","sha256":"7f79f192e6fd9b8c2a1caca2c9231040d499648e3a8695a46cc4900c8bf41d5f","parts":1,"part":1} -->
...
## src/EventBooking.Infrastructure/Persistence/Queries/AuditQueries.cs — 1/1

<!-- port-file: {"path":"src/EventBooking.Infrastructure/Persistence/Queries/AuditQueries.cs","encoding":"utf8","sha256":"95907564895c6ede34d3489cc178379a2d0fbb5983dfb113f50c751f87f8e049","parts":1,"part":1} -->
...
## src/EventBooking.Infrastructure/Persistence/Queries/CandidateBookingQueries.cs — 1/1

<!-- port-file: {"path":"src/EventBooking.Infrastructure/Persistence/Queries/CandidateBookingQueries.cs","encoding":"utf8","sha256":"3898b14c781a4c5192b5a5a37a9b8bfcaefc5afd520f5d0c58fe46c0c4668954","parts":1,"part":1} -->
...
## src/EventBooking.Infrastructure/Persistence/Queries/CandidateReadinessQueries.cs — 1/1

<!-- port-file: {"path":"src/EventBooking.Infrastructure/Persistence/Queries/CandidateReadinessQueries.cs","encoding":"utf8","sha256":"529953feaff3ee1ae1224889b93a9391009fd262496189cda7d4e72ec93f2b98","parts":1,"part":1} -->
