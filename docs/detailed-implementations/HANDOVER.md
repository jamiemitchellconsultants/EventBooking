...
| Phase 4 — master Tasks 21–23 | **In progress.** Task 21 written; master Task 22 split into 22a/22b (see §8). Hand-authored, like Phase 3, and never executed |
...
| 4 | `phase-4-api-and-mcp.md` | `phase-4a-api-conventions.md` (Task 21). Still to write: `phase-4b-event-read-models.md` (22a), `phase-4c-endpoint-catalogue.md` (22b), `phase-4d-mcp-parity.md` (23, phase gate) |
...
3. **Phase 4 (Tasks 21–23) is in progress, and stays hand-authored.** Follow section 6a's loop, and
   ...
   - **Master Task 22 is split into 22a and 22b** (§8, contradiction #11), so three documents
     remain: `phase-4b-event-read-models.md`, `phase-4c-endpoint-catalogue.md` and
     `phase-4d-mcp-parity.md`. Task 23 carries the phase's pull-request gate.
   - Task 22a and 22b inherit settlements #12 and #13 as well: the two-capability rule on
     `GET /api/events`, and attendee readiness moving to `ViewAttendeeDashboards`.
