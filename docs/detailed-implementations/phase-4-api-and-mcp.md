...
**Status: Task 21 written.** Phase 4 is hand-authored, like Phase 3: complete code and tests are
...
| 2 | Task 22a — the read models the catalogue needs | phase-4b-event-read-models.md | `feat(api): full EventBooking endpoint catalogue` |
