...
**Phases 0, 1 and 2 are complete and executable. Phase 3 Task 12 is written (hand-authored, not yet executed). Tasks 13–33 are not yet written.** Tasks 1 to 11, including the lettered splits 3a–3d and 9a–9b, are documented, implemented and replayed from these documents into an independent checkout, ending at a green build and 1570 passing tests. Master Tasks 13–33 still have to be authored; read [the authoring handover](HANDOVER.md) before continuing that work.
