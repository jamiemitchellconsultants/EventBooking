...
**Phases 0, 1 and 2 are complete and executable. Phases 3 (Tasks 12–20, with Task 20 split into 20a/20b), 4 (Tasks 21–23, with Task 22 split into 22a/22b), 5 (Tasks 24–27) and 6 (Tasks 28–31) are hand-authored and not yet executed. Tasks 32–33 are not yet written.** Tasks 1 to 11, including the lettered splits 3a–3d and 9a–9b, are documented, implemented and replayed from these documents into an independent checkout, ending at a green build and 1570 passing tests. Read [the authoring handover](HANDOVER.md) before continuing; it records the binding settlements and the verification limits of every unexecuted phase.
